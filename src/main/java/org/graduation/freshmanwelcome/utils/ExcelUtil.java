package org.graduation.freshmanwelcome.utils;
...
import org.graduation.freshmanwelcome.exception.ExcelExceptionCode;
import org.graduation.freshmanwelcome.factory.ExcelWriterFactory;
import org.graduation.freshmanwelcome.listener.ExcelListener;
...
public class ExcelUtil {
    ...
    private static OutputStream getOutputStream(String fileName, HttpServletResponse response) {
        ...
        try {
            ...
            throw new CustomizeException(ExcelExceptionCode.EXPORT_EXCEPTION);
        }
    }
    ...
    private static ExcelReader getReader(MultipartFile excel, ExcelListener excelListener) {
        ...
        if (filename == null || (!filename.toLowerCase().endsWith(".xls") && !filename.toLowerCase().endsWith(".xlsx"))) {
            throw new CustomizeException(ExcelExceptionCode.ERRO_FILE_FORMAT);
        }
    ...
    public static ExcelTypeEnum valueOf(InputStream inputStream) {
        try {
            ...
            throw new CustomizeException(ExcelExceptionCode.NULL_EXCELTYPEENUM);
